...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'profile.skillsCerts': 'Skills & Certifications',
    'profile.about': 'About',
    'profile.completedWork': 'Completed Work',
    'profile.noCompletedJobs': 'No completed jobs yet',
    'profile.reviewsRatings': 'Reviews & Ratings',
    'profile.noReviews': 'No reviews yet',
    'profile.skills': 'Skills',
    'profile.certifications': 'Certifications',
    'profile.noSkillsCerts': 'No skills or certifications added yet',
    'profile.bio': 'Bio',
    'profile.noBio': 'No bio provided',
    'profile.serviceArea': 'Service Area',
    'profile.memberSince': 'Member Since',
    'profile.message': 'Message',
    'profile.messageInfo': 'Messaging Available After Quote',
    'profile.messageDescription': 'Request a quote first to start messaging this provider about your project',
    'profile.completedJobs': 'Completed Jobs',
    'profile.rating': 'Rating',
    'profile.availableNow': 'Available Now',
    'profile.availableSoon': 'Available Soon',
    'profile.loadingProfile': 'Loading profile...',
    'profile.notFound': 'Profile not found',
    'profile.response': 'response',
    'profile.instantBooking': 'Instant Booking',
    'profile.years': 'years',
    'profile.issued': 'Issued',
    'profile.expires': 'Expires',
    // Header
    'header.support': 'Support',
    'header.findProviders': 'Find Providers',
  },
  es: {
    // Navigation
    'nav.home': 'Inicio',
    ...
    'profile.skillsCerts': 'Habilidades y Certificaciones',
    'profile.about': 'Acerca de',
    'profile.completedWork': 'Trabajos Completados',
    'profile.noCompletedJobs': 'Aún no hay trabajos completados',
    'profile.reviewsRatings': 'Reseñas y Calificaciones',
    'profile.noReviews': 'Aún no hay reseñas',
    'profile.skills': 'Habilidades',
    'profile.certifications': 'Certificaciones',
    'profile.noSkillsCerts': 'Aún no se han agregado habilidades o certificaciones',
    'profile.bio': 'Biografía',
    'profile.noBio': 'No se proporcionó biografía',
    'profile.serviceArea': 'Área de Servicio',
    'profile.memberSince': 'Miembro Desde',
    'profile.message': 'Mensaje',
    'profile.messageInfo': 'Mensajería Disponible Después de Cotizar',
    'profile.messageDescription': 'Solicita una cotización primero para comenzar a enviar mensajes a este proveedor sobre tu proyecto',
    'profile.completedJobs': 'Trabajos Completados',
    'profile.rating': 'Calificación',
    'profile.availableNow': 'Disponible Ahora',
    'profile.availableSoon': 'Disponible Pronto',
    'profile.loadingProfile': 'Cargando perfil...',
    'profile.notFound': 'Perfil no encontrado',
    'profile.response': 'respuesta',
    'profile.instantBooking': 'Reserva Instantánea',
    'profile.years': 'años',
    'profile.issued': 'Emitido',
    'profile.expires': 'Expira',
    // Header
    'header.support': 'Soporte',
    'header.findProviders': 'Buscar Proveedores',
  },
};
